...
import { Code2, Cpu, Globe, Layout, Rocket, Shield, Sparkles, Zap, ArrowRight, CheckCircle2, Monitor, Database, Smartphone } from "lucide-react";
...
export default function WebDevelopmentPage() {
    const stats = [
        { label: "PERFORMANCE", value: "99/100", icon: <Zap className="w-5 h-5" /> },
        { label: "LOAD TIME", value: "< 1.2s", icon: <Rocket className="w-5 h-5" /> },
        { label: "CLIENT RETENTION", value: "94%", icon: <Globe className="w-5 h-5" /> },
    ];

    const features = [
        {
            title: "Custom Web Apps",
            desc: "Bespoke web applications built with Next.js and React for maximum speed and SEO performance.",
        ...
        },
        {
            ...
            desc: "Architecture designed to handle millions of users with rock-solid security and performance.",
        ...
        },
        {
            ...
            desc: "Interfaces that don't just look pretty but are engineered to convert visitors into customers.",
        ...
        },
        {
            ...
            desc: "Offline-capable PWAs that give your web experience a native mobile app feel.",
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        >
                            ...
                            >
                                ...
                                #1 Web Development in Bangalore
                            </m.div>
                            ...
                            >
                                Web <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Development.</span>
                            </m.h1>
                            ...
                            >
                                We don't just build websites; we engineer digital growth engines. Scalable, secure, and
                                <span className="text-brand-blue font-bold"> blazing fast</span> web apps for the modern era.
                            </m.p>
                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    <span className="text-2xl font-black text-brand-blue">99+</span>
                                    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Lighthouse Score</span>
                                </div>
                            </m.div>
                        </m.div>
                        ...
                        >
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gray-50 aspect-[16/10] border border-gray-100 group">
                                <Image
                                    src="/images/web_development_new.png"
                                    alt="Web Development Agency Bangalore - Custom Next.js & React Websites"
                                    fill
            ...
            <section className="py-16 md:py-20 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-500 font-medium max-w-2xl">Modern technology meets conversion-focused design to help your business scale.</p>
                    </m.div>
                ...
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    >
                        ...
                        <ul className="space-y-4">
                            {[
                                "React & Next.js for blazing speed",
                    ...
                    >
                        <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                            <h3 className="text-2xl font-black text-brand-blue mb-4">Why Triuss Web?</h3>
                            <p className="text-gray-500 font-medium leading-relaxed mb-8">
                                In a world where 0.1 seconds affects conversion, we prioritize performance. Our web apps are not just beautiful—they are optimized for speed, search engines, and maximum user engagement.
                            </p>
                            <Link href="/#contact" className="text-blue-600 font-black flex items-center gap-2 hover:gap-3 transition-all uppercase tracking-widest text-xs">
