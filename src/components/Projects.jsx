...
const clients = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=800&h=500&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545205569-0d3454124973?w=800&h=500&fit=crop",
    ...
    >
      <div className="relative aspect-video w-full overflow-hidden bg-gray-100">
        ...
        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
          <a href={client.url} target="_blank" rel="noopener noreferrer" className="bg-white/90 p-3 rounded-full hover:bg-red-accent hover:text-white transition-colors">
